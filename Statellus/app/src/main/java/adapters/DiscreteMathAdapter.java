...
/**
 * Custom adapter for populating a ListView with discrete math data.
 * Extends {@link BaseAdapter}.
 */
public class DiscreteMathAdapter extends BaseAdapter {

    private final DiscreteMathListView discreteMathListView;
    private final String[] title;
    private final LayoutInflater inflater;

    /**
     * Constructor for the DiscreteMathAdapter.
     *
     * @param discreteMathListView The associated activity or fragment for the adapter.
     * @param title                Array of titles to be displayed in the ListView.
     */
    public DiscreteMathAdapter(DiscreteMathListView discreteMathListView, String[] title) {
        this.discreteMathListView = discreteMathListView;
        this.title = title;
        this.inflater = (LayoutInflater) discreteMathListView.getSystemService(Context.LAYOUT_INFLATER_SERVICE);
    }
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        holder.ll_bg.setBackground(ContextCompat.getDrawable(discreteMathListView, R.drawable.gradient_3));
