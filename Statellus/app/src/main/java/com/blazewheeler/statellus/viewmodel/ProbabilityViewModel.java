...
import com.blazewheeler.statellus.view.BayesTheoremView;
import com.blazewheeler.statellus.view.ProbabilityListView;


public class ProbabilityViewModel extends ProbabilityListView {
    /**
    ...
    public void onListItemClicked(Context context, int position) {
        switch (position) {
            case 0:
                ...
                context.startActivity(new Intent(context, BayesTheoremView.class));
                break;
